local strings = {
  ...
  PRISMATICWARNING_MENU_AUTO_SWAP_TT = 'The addon will attempt to automatically slot the prismatic weapon to the bar you choose; "Dont" will not attempt to auto-swap',
